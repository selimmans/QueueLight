...
## PHASE 25b — Kotn Cup 26: multi-shirt orders + full design-handoff-2 redesign (NOT YET DEPLOYED)
...
- [ ] **NOT committed or deployed.** Everything above is local-only. Given this touches live production order-numbering logic and two real customers' existing orders were migrated, get explicit go-ahead before pushing/deploying this one.
